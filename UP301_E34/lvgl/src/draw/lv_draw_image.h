...
struct _lv_draw_image_dsc_t {
    ...
    /**The rotation of the image in 0.1 degree unit. E.g. 234 means 23.4¢X */
    int32_t rotation;
    ...
    /**Parallelogram like transformation of the image horizontally in 0.1 degree unit. E.g. 456 means 45.6¢X.*/
    int32_t skew_x;
