...
enum_pmp_retcode_Type metal_pmp_set_executable(struct metal_pmp *pmp, uint32_t region,
										 uint32_t X) {
    struct metal_pmp_config config;
    size_t address;
    uint32_t rc = 0;
