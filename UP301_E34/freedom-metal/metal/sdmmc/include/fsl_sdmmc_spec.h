...
#define SDMMC_CLOCK_200KHZ (200000U)
/*! @brief SD/MMC card initialization clock frequency */
...
#define MMC_CLOCK_HS200 (150000000U)	// Mimi: for UP301
...
typedef enum _sdmmc_command
{
    ...
    kSDMMC_SendWriteProtectType = 31U, /*!< Send Write Protect Type*/
...
typedef enum _mmc_erase
{
    kMMC_Erase = 0x00000000, /*!< Erase group */
    kMMC_Discard = 0x00000003,
    kMMC_Trim = 0x00000001,
    kMMC_SecureErase = 0x80000000,
    kMMC_SecureTrim1 = 0x80000001,
    kMMC_SecureTrim2 = 0x80008000,
} mmc_erase_t;
...
typedef enum _mmc_command
{
    ...
    kMMC_StandbyTransfer        = 7U,  /*!< stand-by Transfer */
...
typedef enum _mmc_extended_pwr_off_notification
{
    kMMC_CsdNoPoweroffNotification = 0U,
    kMMC_CsdPoweredOn = 1U,
    kMMC_CsdPowerOffShort = 2U,
    kMMC_CsdPowerOffLong = 3U,
} mmc_extended_pwr_off_notification_t;
...
typedef enum _mmc_extended_csd_index
{
    ...
    kMMC_ExtendedCsdIndexPwrOffNotification   = 34U,  /*!< power off notification */
    kMMC_ExtendedCsdIndexClass6Control        = 59U,  /*!< class 6 control */
    kMMC_ExtendedCsdIndexSanitize             = 165U, /*!< sanitize */
    kMMC_ExtendedCsdIndexUserWP               = 171U, /*!< write protection */
    ...
    kMMC_ExtendedCsdIndexPowerOffLongTime     = 247U, /*!< power off long time */
