...
/*!
 * @file init.h
 * @brief API for Metal constructors and destructors
 */
...
/*!
 * @brief INITs return error code.
 * @ingroup UP301_Metal constructors & destructors
 */
typedef enum enum_init_retcode{
    E_INIT_SUCCESS,     // Success.
	E_INIT_INVINIT,	 	// Initial fail or resource is unavailable.
	E_INIT_INVPARA,	 	// Invalid function parameter/argument.
    E_INIT_ERROR,     	// Unspecific error.
} enum_init_retcode_Type;
 ...
 * @return enum_init_retcode_Type error call.
 */
