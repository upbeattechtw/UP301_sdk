...
/*! @brief Enums for privilege return codes */
typedef enum enum_privilege_retcode{
    E_PRIVILEGE_SUCCESS,     // Success.
	E_PRIVILEGE_INVINIT,	 	// Initial fail or resource is unavailable.
	E_PRIVILEGE_INVPARA,	 	// Invalid function parameter/argument.
    E_PRIVILEGE_ERROR,     	// Unspecific error.
} enum_privilege_retcode_Type;
...
/*! 
 *  @brief metal_privilege_drop_to_mode
 *  @return privilege return codes
*/
